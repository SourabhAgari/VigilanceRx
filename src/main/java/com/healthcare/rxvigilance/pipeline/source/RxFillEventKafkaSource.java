...
public class RxFillEventKafkaSource {
    ...
    public static DataStream<RxFillEvent> build(StreamExecutionEnvironment env,
        ...
        env.getConfig().registerTypeWithKryoSerializer(RxFillEvent.class, RxFillEventKryoSerializer.class);
    ...
    static Properties securityProperties(KafkaConnectionConfig kafkaConfig) {
