...
class TypedKafkaRecordDeserialisationSchemaTest {
    ...
    void getProducedTypeReturnsWhatWasConfigured() {
        ...
        TypedKafkaRecordDeserialisationSchema<DrugClassRefUpdate> schema =
                new TypedKafkaRecordDeserialisationSchema<>(
    ...
    void deserializeNeverThrowsEvenWhenRegistryIsUnreachable() throws Exception {
        TypedKafkaRecordDeserialisationSchema<DrugClassRefUpdate> schema = schemaAgainstUnreachableRegistry();
        schema.open(null);
    ...
    private TypedKafkaRecordDeserialisationSchema<DrugClassRefUpdate> schemaAgainstUnreachableRegistry() {
        return new TypedKafkaRecordDeserialisationSchema<>(
